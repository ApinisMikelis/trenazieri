...
?>
<div <?php wc_product_class( 'tre-product-card', $product ); ?>>
  <?php
  ...
  <?php if (is_user_logged_in()) :
    ...
    if ($tags && !is_wp_error($tags)) :
      ...
      ?>
        <div class="admin-product-tags">
            <span class="tag-counter"><?php echo $tag_count; ?> Tags</span>
            <div class="tag-list">
    ...
    <?php
      ...
      if ($internal_links === 0) $internal_links = (int) get_post_meta($post_id, '_yoast_wpseo_linkdex_internal_links_count', true);
      if ($external_links === 0) $external_links = (int) get_post_meta($post_id, '_yoast_wpseo_linkdex_outbound_links_count', true);
  
      if ($internal_links > 0 || $external_links > 0) :
      ?>
          <div class="admin-link-info admin-yoast-info">
              Links: 
